              ...
              <h3 class="card-header">
                Let us learn about Stock Market!
                  ...
                  <div class="card-body">
                    ...
                    <p><h6 class="card-subtitle text-muted">The Bull and Bear market meet UP! who is next?</h6></p>
                  </div>
                  ...
                  <div class="card text-white bg-warning mb-3">
                    <div class="card-header card-title"><h3>Stock market basics</h3></div>
                    <div class="card-body">
                      <p class="card-text">
                      ...
                      <a href="https://www.nerdwallet.com/article/investing/how-to-invest-in-stocks" class="btn btn-primary" target="_blank">How To invest in stocks</a>
                    </div>
                  </div>


                  <div class="card text-white bg-warning mb-3">
                    <div class="card-header card-title"><h3>Understanding the stock market</h3></div>
                    <div class="card-body">
                      <p class="card-text">
                          ...
                          <a href="https://www.nerdwallet.com/blog/investing/what-is-the-stock-market/" class="btn btn-primary" target="_blank">How the market works</a>
                        </div>
                      </div>


                 <div class="card text-white bg-warning mb-3">
                    <div class="card-header card-title"><h3>Bull markets vs. bear markets</h3></div>
                    <div class="card-body">
                      <p class="card-text">
                          ...
                          <a href="https://www.nerdwallet.com/blog/investing/average-stock-market-return/" class="btn btn-primary" target="_blank">What is avarage return</a>
                        </div>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <h3 class="card-header card mb-3">
                    ...
                    { this.state.articles.map((article, index) => {
                      return(
                        ...
                        <div class="card-header">{ article.source }</div>
                          <div class="card-body">
                            <h5 class="card-title" style={{color: 'darkblue'}}>{ article.headline }</h5>
                            <h6 class="card-subtitle mb-2 text-muted"> Source: { article.source } </h6>
                            <p class="card-text">{article.summary}</p>
                            <p align="right"><a href={article.url} class="btn btn-primary" align="right" target="_blank">Continue Reading Here</a></p>
                          </div>
                        </div>
                        ...
                        <div class="card-body">
                            <a href="https://iexcloud.io" class="card-link" target="_blank"> Chart Data provided by IEX Cloud</a> <br />
